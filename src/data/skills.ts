...
export const skills: Skill[] = [
  ...
  { name: "HTML", category: "language", proficiency: "proficient", yearsExperience: 8 },
  { name: "CSS", category: "language", proficiency: "proficient", yearsExperience: 8 },
  { name: "Ruby", category: "language", proficiency: "proficient", yearsExperience: 3 },
  { name: "tRPC", category: "framework", proficiency: "proficient", yearsExperience: 1 },
  { name: "Prisma ORM", category: "tool", proficiency: "proficient", yearsExperience: 2 },
  { name: "MySQL", category: "database", proficiency: "proficient", yearsExperience: 4 },
  { name: "Redis", category: "database", proficiency: "proficient", yearsExperience: 3 },
  { name: "Stripe", category: "tool", proficiency: "proficient", yearsExperience: 2 },
  { name: "OpenAI API", category: "tool", proficiency: "proficient", yearsExperience: 2 },
  { name: "REST APIs", category: "tool", proficiency: "proficient", yearsExperience: 6 },
  { name: "Web3", category: "tool", proficiency: "proficient", yearsExperience: 2 },
  { name: "Analytics", category: "tool", proficiency: "proficient", yearsExperience: 5 },
  { name: "Agile", category: "tool", proficiency: "proficient", yearsExperience: 6 },
